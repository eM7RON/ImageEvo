...
# Form implementation generated from reading ui file 'gpso_display_ui.ui'
#
...
class Ui_GpsoDisplayWindow(object):
    def setupUi(self, GpsoDisplayWindow):
        ...
        spacerItem7 = QtWidgets.QSpacerItem(3, 22, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem8 = QtWidgets.QSpacerItem(40, 25, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem9 = QtWidgets.QSpacerItem(50, 22, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, GpsoDisplayWindow):
        ...
        GpsoDisplayWindow.setWindowTitle(_translate("GpsoDisplayWindow", "𝕀mage𝔼vo"))
        self.toggle_series_label.setText(_translate("GpsoDisplayWindow", "Toggle series:"))
        self.bst_checkbox.setText(_translate("GpsoDisplayWindow", "Global best"))
        self.wst_checkbox.setText(_translate("GpsoDisplayWindow", "Global worst"))
        self.avg_checkbox.setText(_translate("GpsoDisplayWindow", "Average (x̄)"))
        self.std_checkbox.setText(_translate("GpsoDisplayWindow", "Std. (±σ)"))
        self.label_2.setText(_translate("GpsoDisplayWindow", "Stats:"))
        self.n_pop_label.setToolTip(_translate("GpsoDisplayWindow", "<html><head/><body><p>The number of individuals in the population.</p></body></html>"))
        self.n_pop_label.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" color:#000000;\">Population size:</span></p></body></html>"))
        self.n_pop_indicator.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" font-weight:400; color:#000000;\">0</span></p></body></html>"))
        self.n_shape_label.setToolTip(_translate("GpsoDisplayWindow", "<html><head/><body><p>The number of shapes possessed by an individual solution.</p></body></html>"))
        self.n_shape_label.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" color:#000000;\">n_shape:</span></p></body></html>"))
        self.n_shape_indicator.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" font-weight:400; color:#000000;\">0</span></p></body></html>"))
        self.fitness_label.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" color:#000000;\">Fitness:</span></p></body></html>"))
        self.fitness_indicator.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" font-weight:400; color:#000000;\">0</span></p></body></html>"))
        self.distance_label.setToolTip(_translate("GpsoDisplayWindow", "<html><head/><body><p>The distance (squared euclidean) between the globals best and original image.</p></body></html>"))
        self.distance_label.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" color:#000000;\">Distance:</span></p></body></html>"))
        self.distance_indicator.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" font-weight:400; color:#000000;\">0</span></p></body></html>"))
        self.iter_label.setToolTip(_translate("GpsoDisplayWindow", "<html><head/><body><p>Number of iterations of the algorithm since it was instantiated.</p></body></html>"))
        self.iter_label.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" color:#000000;\">Iterations:</span></p></body></html>"))
        self.iter_indicator.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" font-weight:400; color:#000000;\">0</span></p></body></html>"))
        self.update_label.setToolTip(_translate("GpsoDisplayWindow", "<html><head/><body><p>The number of iterations since a new global best was achieved.</p></body></html>"))
        self.update_label.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" color:#000000;\">Iter. since improvement:</span></p></body></html>"))
        self.isi_indicator.setText(_translate("GpsoDisplayWindow", "<html><head/><body><p><span style=\" font-weight:400; color:#000000;\">0</span></p></body></html>"))
...
from ui.matplotlib_widgets import GpsoFigureWidget
