...
class Ui_ImageEditor(object):
    def setupUi(self, ImageEditor):
        ...
        ImageEditor.setMinimumSize(QtCore.QSize(357, 630))
        ImageEditor.setMaximumSize(QtCore.QSize(357, 630))
        ...
        self.image_editor_label.setMinimumSize(QtCore.QSize(100, 27))
        ...
        self.img_widget_2 = QtWidgets.QLabel(ImageEditor)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.img_widget_2.sizePolicy().hasHeightForWidth())
        self.img_widget_2.setSizePolicy(sizePolicy)
        self.img_widget_2.setMinimumSize(QtCore.QSize(100, 100))
        self.img_widget_2.setMaximumSize(QtCore.QSize(100, 100))
        self.img_widget_2.setText("")
        self.img_widget_2.setPixmap(QtGui.QPixmap("../img/gfx/paint_img.svg"))
        self.img_widget_2.setScaledContents(True)
        self.img_widget_2.setObjectName("img_widget_2")
        self.horizontalLayout.addWidget(self.img_widget_2)
        ...
        spacerItem6 = QtWidgets.QSpacerItem(94, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.preset_filter_dropdown.setMinimumSize(QtCore.QSize(180, 25))
        self.preset_filter_dropdown.setMaximumSize(QtCore.QSize(180, 25))
        ...
        self.filter_label.setMinimumSize(QtCore.QSize(100, 0))
        self.filter_label.setMaximumSize(QtCore.QSize(100, 16777215))
        ...
        self.filter_dropdown.setMinimumSize(QtCore.QSize(180, 25))
        self.filter_dropdown.setMaximumSize(QtCore.QSize(180, 25))
        ...
        self.kernel_size_entry.setMinimumSize(QtCore.QSize(75, 25))
        self.kernel_size_entry.setMaximumSize(QtCore.QSize(75, 25))
        ...
        spacerItem9 = QtWidgets.QSpacerItem(169, 24, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem10 = QtWidgets.QSpacerItem(169, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, ImageEditor):
        ...
        self.image_editor_label.setText(_translate("ImageEditor", "<html><head/><body><p><span style=\" font-weight:600;\">Image Editor</span></p></body></html>"))
        ...
        self.kernel_size_label.setText(_translate("ImageEditor", "Filter size arg."))
